...
int main() {
    ...
    struct {
        ...
        __le32 fs_count;
        __le32 hs_count;
        functionfs_descriptors_t fs_descriptors;
        functionfs_descriptors_t hs_descriptors;
    ...
    memcpy(&descriptors.hs_descriptors, &descriptors.fs_descriptors, sizeof(functionfs_descriptors_t));
    ...
    struct {
        ...
        struct {
            __le16 code;
            char str1[32]; // Removed 'const' keyword
    ...
    strncpy(strings.lang0.str1, "Virtual USB Function", sizeof(strings.lang0.str1));
